...
module.exports = "<ngb-accordion #acc=\"ngbAccordion\" activeIds=\"0\"> \n\n    <ngb-panel id=\"0\">\n        <ng-template ngbPanelTitle>\n            <div class=\"pnl-title\">\n                <h2>About Me</h2>\n            </div>\n        </ng-template>\n        <ng-template ngbPanelContent>\n            <p class=\"block-txt\">I am a US Navy veteran with 9 years of experience in electronics, currently transitioning careers from computer hardware to software and full stack web development.</p>\n                <p class=\"block-txt\">Previously, I have been a radar systems work center supervisor on board the USS Nimitz, out of Bremerton, WA.  Translating that to civilian terms, I was an electronics technician, product owner, project manager, and I also managed my division’s training program overseeing the continuing education for 30 personnel.  After my time in the Navy, I still wanted to work in a technical field, so I took up an opportunity to work with an e-cigarette startup, ProVape Inc, in Monroe, WA, running their electronics repair lab.  I then jumped ship over to Microsoft, in Redmond, where I worked as an electrical engineering technician on various projects for the Microsoft Surface product line.  After Microsoft, I decided to expand my skills in tech while not being confined to a lab, so I decided to learn more about software development.</p>\n                <p class=\"block-txt\">What attracts me to software development is how it’s a portable skillset that I can practice from anywhere, allows for more creativity than being a technician, and is more project-oriented, which I like because of the structure and oversight that is involved.  So I enrolled at Coding Dojo, in Bellevue, WA where I learned Python, C#, and a Javascript-based stack called MEAN, on top of HTML and CSS.  While at the dojo, I logged over 1,000 hours of computer programming instruction, and worked on an awesome project with two other classmates: a website designed for parents of underprivileged youth in the Seattle area to find food, learning, and activity resources during summer break; services children would otherwise get at school (not currently deployed, but fully functional in a development environment).</p>\n                <p class=\"block-txt\">I would ultimately like to find myself in a role where I can add value to a project at every one of its phases while collaborating with other goal-driven team members to produce awesome product and user experiences.</p>\n        </ng-template>\n    </ngb-panel>\n\n    <ngb-panel>\n        <ng-template ngbPanelTitle>\n            <div class=\"pnl-title\">\n                <h2>Experience</h2>\n            </div>\n        </ng-template>\n        <ng-template ngbPanelContent>\n            <ul class=\"exp-list\">\n                <li>\n                    <h3>Microsoft (via Nytec, Inc.) - <em>Redmond, WA</em></h3>\n                    <h4>Electrical Engineering Technician</h4>\n                    <p>November 2016 - May 2018</p>\n                    <ul class=\"exp-list-nested\">\n                        <li>Provided hands-on hardware engineering support, problem solving, and failure analysis for the entire Microsoft Surface product line: Surface Pro, Surface Hub, Surface Book, and Surface Laptop.</li>\n                        <li>Ensured timely resolution of hardware bugs while streamlining internal processes and coordinating across functional teams (mechanical engineers, design engineers, etc.) to keep projects moving forward according to schedule.</li>\n                        <li>Solid background in component-level troubleshooting, repair, assembly, soldering, testing, inspection, and calibration of printed circuit boards with extreme precision, attention to detail, and specifications.</li>\n                        <li>Proficient in working with an array of electronic test equipment: multimeters, oscilloscopes, spectrum analyzers, soldering stations, thermal imagers, DC power supplies, microscopes, and pneumatic machinery.</li>\n                        <li>Authored procedures for testing and validating prototype computer hardware, and documented all repair activity and root-cause information in Microsoft Team Foundation Server for future reference by engineering and management.</li>\n                    </ul>\n                </li>\n                <hr>\n                <li>\n                    <h3>Provape, Inc. - <em>Monroe, WA</em></h3>\n\n                    <h4>Lead Electronics Technician</h4>\n                    <p>May 2015 - August 2016</p>\n                    <ul class=\"exp-list-nested\">\n                        <li>Adept at organizing and streamlining the electronics repair operations, ensuring 24 to 48 hours turnaround on customer returned units utilizing a first-in-first-out tracking system, maximizing workshop efficiency and customer satisfaction.</li>\n                        <li>Met and exceeded all company-assigned objectives and tasks ahead of schedule with minimal supervision.</li>\n                        <li>Utilized schematic diagrams and component data sheets for reference while conducting circuit repairs.</li>\n                        <li>Beta-tested products pre-launch and coordinated usage information with production and engineering departments for future product development and improvement.</li>\n                    </ul>\n                </li>\n                <hr>\n                <li>\n                    <h3>United States Navy - <em>USS Nimitz CVN-68</em></h3>\n                    <h4>Work Center Supervisor</h4>\n                    <p>May 2009 - May 2015</p>\n                    <ul class=\"exp-list-nested\">\n                        <li>Developed and maintained preventive and corrective maintenance roadmaps for 2 radar systems directly related to mission readiness in a lean six-sigma environment.</li>\n                        <li>Ensured 96% continual operation of 2 radar systems serving data to internal stakeholders over a 261-day at-sea deployment.</li>\n                        <li>Provided training and leadership for a team of 6 radar technicians, overseeing the completion of 1,164 individual tasks to support mission readiness. </li>\n                        <li>Planned, coordinated, and assisted outside support for system installations and upgrades that were beyond the scope of ships’ personnel, including the replacement and realignment of a 6,660-lb, $900K radar antenna.</li>\n                        <li>Administered continually updated inventories of essential tools, spare parts, test equipment, and materials, ensuring adequate and compatible supplies for performing workshop duties.</li>\n                        <li>Maintained Secret Security Clearance.</li>\n                    </ul>\n                </li>\n            </ul>\n        </ng-template>\n    </ngb-panel>\n\n    <ngb-panel>\n        <ng-template ngbPanelTitle>\n            <div class=\"pnl-title\">\n                <h2>Education</h2>\n            </div>\n        </ng-template>\n        <ng-template ngbPanelContent>\n            <ul class=\"exp-list edu-ctr\">\n                <li>Certificate of Completion in Software & Web Development • Coding Dojo, Bellevue, WA</li>\n                <li>Master of Business Administration, Global Marketing • City University of Seattle, Seattle, WA</li>\n                <li>Lean Six Sigma Yellow Belt • United States Navy</li>\n                <li>Apprentice Electronics Training • United States Navy</li>\n                <li>Bachelor of Science, Entertainment Business • Full Sail University, Winter Park, FL</li>\n            </ul>\n        </ng-template>\n    </ngb-panel>\n</ngb-accordion>"
